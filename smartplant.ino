...
while(analogRead(sensorLuz)<500){
if(analogRead(sensorUmid) >= 80 && analogRead(sensorUmid) < 250) {
...
} else if(analogRead(sensorUmid) >= 250 && analogRead(sensorUmid) < 350) {
...
else if(analogRead(sensorUmid) >= 350 && analogRead(sensorUmid) < 450) {
...
else if(analogRead(sensorUmid) >= 450 && analogRead(sensorUmid) < 550) {
...
else if(analogRead(sensorUmid) >= 550 && analogRead(sensorUmid) < 650) {
